...
description: >
  ...
  `react.md` or `sveltekit.md` when the implementation is stack-specific.
---
...
- `sveltekit.md` for SvelteKit-specific routing, data loading, forms, and SSR guidance
...
- The task is explicitly SvelteKit-based
